package org.srr.dev.okhttp;

import android.os.Handler;
import android.os.Looper;
import android.util.Log;

import org.srr.dev.okhttp.builder.GetBuilder;
import org.srr.dev.okhttp.builder.HeadBuilder;
import org.srr.dev.okhttp.builder.OtherRequestBuilder;
import org.srr.dev.okhttp.builder.PostFileBuilder;
import org.srr.dev.okhttp.builder.PostFormBuilder;
import org.srr.dev.okhttp.builder.PostStringBuilder;
import org.srr.dev.okhttp.callback.Callback;
import org.srr.dev.okhttp.cookie.CookieJarImpl;
import org.srr.dev.okhttp.cookie.store.CookieStore;
import org.srr.dev.okhttp.cookie.store.HasCookieStore;
import org.srr.dev.okhttp.cookie.store.MemoryCookieStore;
import org.srr.dev.okhttp.https.HttpsUtils;
import org.srr.dev.okhttp.log.LoggerInterceptor;
import org.srr.dev.okhttp.request.RequestCall;
import org.srr.dev.okhttp.utils.Exceptions;
...
public class OkHttpUtils
{
    ...
    public static final int FAILORE_CODE = 123456;
    public static final String FAILORE_MESSAGE = "请求失败";
    ...
    public void execute(final RequestCall requestCall, Callback callback)
    {
        ...
        requestCall.getCall().enqueue(new okhttp3.Callback()
        {
            ...
            {
                sendFailResultCallback(call, e, finalCallback,FAILORE_CODE,FAILORE_MESSAGE);
            }
            @Override
...
//                }
                ...
                {
                    sendFailResultCallback(call, e, finalCallback,response.code(),response.message());
    ...
    public void sendFailResultCallback(final Call call, final Exception e, final Callback callback,final int code,final  String message)
    {
        ...
        mDelivery.post(new Runnable()
        {
            ...
            public void run()
            {
                callback.onError(call, e,code,message);
                callback.onAfter();
            }
        });
    }
